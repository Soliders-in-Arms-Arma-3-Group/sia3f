...
private _actionConfirm = [QGVAR(safeStart_missionStartConfirm), "Confirm", "", { call EFUNC(core,startMission); }, { !(missionNamespace getVariable [QEGVAR(core,missionStarted), false]) }] call ace_interact_menu_fnc_createAction;
